...
| 序号 | 主题 | 说明 | 链接 |
|------|------|------|------|
| 01 | **Lua GC** | 垃圾回收机制、三色标记、分代GC | [Lua GC](01_Lua_GC.md) |
| 02 | **Lua中ipairs和pairs的区别** | 表遍历机制、性能差异 | [Lua中ipairs和pairs的区别](02_Lua中ipairs和pairs的区别.md) |
| 03 | **Lua中点和冒号的区别** | self参数、面向对象语法糖 | [Lua中点和冒号的区别](03_Lua中点和冒号的区别.md) |
| 04 | **Lua string底层实现** | 字符串池、不可变性、柔性数组 | [Lua string底层实现](04_Lua_string底层实现.md) |
| 05 | **Lua table底层实现** | 混合结构、重哈希、内存管理 | [Lua table底层实现](05_Lua_table底层实现.md) |
| 06 | **Lua实现闭包** | 上值、词法作用域、模块化 | [Lua实现闭包](06_Lua实现闭包.md) |
| 07 | **Lua实现面向对象** | 元表、继承、私有成员 | [Lua实现面向对象](07_Lua实现面向对象.md) |
